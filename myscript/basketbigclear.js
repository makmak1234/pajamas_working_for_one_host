...
function exchrt(exchrtv, elem){
	//document.getElementById("elem").innerHTML = " exchrtv= " + exchrtv + " elem= " + elem;
	query = "basketbigclear.php?exchrtv=" + exchrtv + "&elem=" + elem + "&nocache2=" + Math.random() * 1000000;
