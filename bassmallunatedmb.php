...
echo <<<END
				<div class="goodsbasketfontmb">
					<img src="./m/elements/delete_16x16.png" class="goodsbasketclearmb" onclick="goodsbasketcheck('-1', 'FALSE', './')" title="Очистить корзину">
					<table class="m-cart-fullmb" title="Оформить" onclick="movbigcart('$dirbasbi1')">
						<tr>
